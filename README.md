...
Path des variables et nom des fichiers contenants la listes des paths des masques atlas des hemisphères , et de celui contenant la listes des sujets swapés.
